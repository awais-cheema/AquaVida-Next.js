...
export default function SpruceHillsPage() {
    return (
        <PortfolioProjectShell 
            p={{
                ...
                gallery: [
                    {
                        url: '/images/portfolio/spruce_hills/spa.avif',
                        title: 'Integrated Spa',
                        spec: 'Material: Cold-Formed Concrete',
                        size: 'col-span-2 row-span-1'
                    },
                    {
                        url: '/images/portfolio/spruce_hills/Limestone_Macro.avif',
                        title: 'Tonal Depth',
                        spec: 'Detail: Hand-Finished Limestone',
                        size: 'col-span-1 row-span-1'
                    },
                    {
                        url: '/images/portfolio/spruce_hills/Structure_Detail.avif',
                        title: 'Structural Void',
                        spec: 'Engineering: Cantilevered Slabs',
                        size: 'col-span-1 row-span-1'
                    }
                ],

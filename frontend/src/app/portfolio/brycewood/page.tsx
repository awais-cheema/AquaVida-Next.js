...
export default function BrycewoodPage() {
    return (
        <PortfolioProjectShell 
            p={{
                ...
                gallery: [
                    {
                        url: '/images/portfolio/brycewood/Vibrant_Modern.avif',
                        title: 'Geometric Line',
                        spec: 'Zero-Edge Infinity Weir',
                        size: 'col-span-2 row-span-1'
                    },
                    {
                        url: '/images/portfolio/brycewood/Coping_Detail.avif',
                        title: 'Shadow-Box Detail',
                        spec: 'Natural Slate Coping',
                        size: 'col-span-1 row-span-1'
                    },
                    {
                        url: '/images/portfolio/brycewood/Greenery_Macro.avif',
                        title: 'Bio-Integration',
                        spec: 'Native Flora Landscape',
                        size: 'col-span-1 row-span-1'
                    }
                ],

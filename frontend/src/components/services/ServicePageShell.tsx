...
export default function ServicePageShell({ d }: { d: ServiceData }) {
    ...
    return (
        <div className="min-h-screen w-full bg-[#0D0A07] text-[#dce3f0] font-allomira selection:bg-[#0D5699] selection:text-white select-text">
            ...
            <div className="relative z-20 space-y-25 -mt-0 pb-8">
                ...
                <section className="px-6 md:px-16 lg:px-24 max-w-[1800px] mx-auto pt-0 pb-12 mt-[20vw] md:mt-20">
                    <div className="flex flex-col lg:flex-row gap-[50px] md:gap-32">
                        ...
                        <motion.div 
                            ...
                            whileInView="whileInView"
                            viewport={{ once: true }}
                            className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-x-20 gap-y-12"
                        >
                            {d.features.map((f, i) => (
                                <motion.div 
                                    key={i} 
                ...
                {/* ── SERVICES & STANDARDS ────────────────────────────────────── */}
                <section className="px-6 md:px-16 lg:px-24 max-w-[1800px] mx-auto grid grid-cols-1 lg:grid-cols-[1fr_0.45fr] gap-24 mt-20">
                    <motion.div {...kineticEntry} className="p-8 md:p-12 rounded-[32px]" style={glassStyle}>
                        <h2 className="text-[5vw] md:text-[2.8vw] font-bold mb-[8vw] md:mb-8 tracking-tighter">Specialized Construction Solutions</h2>
                    ...
                    <div className="flex flex-col gap-16">
                        <motion.div {...kineticEntry} className="p-8 rounded-[24px] bg-gradient-to-br from-[#91792C]/10 to-transparent border border-[#91792C]/20">
                            <h3 className="text-[5vw] md:text-[2.8vw] font-bold mb-[8vw] md:mb-8 text-white/90">Operational Excellence</h3>

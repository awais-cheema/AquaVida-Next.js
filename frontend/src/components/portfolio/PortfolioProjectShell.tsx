...
export default function PortfolioProjectShell({ p }: { p: ProjectDetail }) {
    ...
    return (
        <div className="min-h-screen bg-[#05070A] text-[#DCE3F0] font-allomira selection:bg-[#0D5699] selection:text-white select-text">
            ...
            {/* ── HERO ── */}
            <section ref={heroRef} className="relative h-[50vh] lg:h-[100vh] flex flex-col justify-end overflow-hidden pb-32">
                ...
                <div className="relative z-10 px-6 md:px-16 lg:px-24 max-w-[1900px] mx-auto w-full">
                    ...
                    >
                        ...
                        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-12">
                            <div>
                                <h1 className="text-[13vw] lg:text-[10vw] font-black leading-[0.9] tracking-normal uppercase mb-2 text-balance">
                                    {p.title}
                                </h1>
            ...
            {/* ── OVERVIEW STORY ── */}
            <section className="px-6 md:px-16 lg:px-24 max-w-[1900px] mx-auto pt-0 pb-32 lg:py-32 mb-32 border-b border-white/5">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-start">
                    <motion.p 
                        {...kineticEntry}
                        className="text-[clamp(26px,2.7vw,72px)] font-normal leading-[1.15] text-white/90 tracking-tight"
                    >
                        {p.description}
                    </motion.p>
                    ...
                    >
                        ...
                        <h3 className="text-xl  font-bold uppercase tracking-widest text-[#A68A33]">The Architectural Intent</h3>
                        <p className="text-2xl text-white/80 leading-relaxed font-normal">
                            {p.technicalBody}
                        </p>
                    </motion.div>
                </div>
            ...
            <section className="px-6 md:px-16 lg:px-24 max-w-[1900px] mx-auto mb-0">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 auto-rows-[400px]">
                    {p.gallery.map((item, i) => (
                        <motion.div
                            ...
                            className={`relative group overflow-hidden rounded-[48px] ${item.size || 'col-span-1'}`}
                        >
            ...
            <section className="px-6 md:px-16 lg:px-24 max-w-[1900px] mx-auto mb-40 mt-32 lg:mt-0">
                <motion.div 
                    {...kineticEntry}
                    className="relative rounded-[80px] overflow-hidden min-h-[900px] flex items-center p-16 md:p-32"
                >
                    ...
                    <div className="relative z-10 max-w-5xl">
                        <span className="text-[#A68A33] font-black tracking-[0.3em] uppercase text-[4vw] lg:text-[1vw]  mb-12 block">THE ARCHITECTURE OF TRANQUILITY</span>
                        <h2 className="text-[clamp(48px,8vw,140px)] font-black leading-[0.8] uppercase mb-16" style={{ letterSpacing: '0.1em' }}>
                            {p.philosophyTitle}
                        </h2>
            ...
            {/* ── FOOTER CTA ── */}
            <section className="px-6 md:px-16 lg:px-24 max-w-[1900px] mx-auto mb-20 text-center">
                <motion.div {...kineticEntry}>
                    <ShieldCheck size={48} className="mx-auto mb-8 text-[#63B589] opacity-40 md:mb-12 md:w-16 md:h-16" />
                    <h2 className="text-5xl md:text-8xl font-black leading-none uppercase mb-10 tracking-tighter">Your Legacy Begins</h2>
                    <p className="text-xl md:text-[1.5vw] text-white/30 font-light max-w-4xl mx-auto mb-16 leading-[1.2em] px-4">
                    ...
                    <Link href="/contact" className="btn inline-flex items-center gap-5 bg-[#A68A33] hover:bg-[#fff] text-white px-8 py-4 rounded-full text-xl font-bold uppercase tracking-widest transition-all hover:scale-105 active:scale-95 group">

...
const sections = [
    {
        id: 'services-scope',
        heading: '1. Services and Scope of Work',
        body: 'Aquavida Pools and Spas is a company that focuses on the creation, construction and upkeep of swimming pools, spas and exterior living features such as patios, kitchens and water elements. The schedule of a project might be changed due to circumstances such as weather, the availability of materials or the regulations of the municipal permits.',
    },
    {
        id: 'quotes-pricing',
        heading: '2. Quotes and Pricing',
        body: 'Any pricing available online or via automated tools should only be seen as indicative; final project quotes will only be provided after an in-person consultation and site evaluation has taken place; these quotes remain valid for 30 days (unless specified differently).',
    },
    {
    ...
    {
        id: 'permits-hoa',
        heading: '4. Permits and HOA Approvals',
        body: 'Customers are solely responsible for procuring city permits, inspections and approvals — we cannot be held liable for delays caused by HOA approval processes that fall outside our purview or municipal reviews that happen independently from us.',
    },
    {
        id: 'warranties',
        heading: '5. Warranties',
        body: 'Most pool contracts include a structural warranty; other items, like pumps and heaters, are covered by separate manufacturer\'s warranties whose conditions and limitations can be found within documentation. Any issues surrounding the warranty must be handled in accordance with your signed agreement terms.',
    },
    {
        id: 'intellectual-property',
        heading: '6. Intellectual Property',
        body: 'All texts, images, logos and designs found herein belong solely to Aquavida Pools and Spas and may not be copied or redistributed without our prior written approval. In addition, we may use photos from clients\' projects for promotional purposes, unless they have made a clear written refusal.',
    },
    {
        id: 'liability',
        heading: '7. Limitation of Liability',
        body: 'Aquavida Pools and Spas LLC will not accept responsibility for damages sustained from use of our website, including an error-free browsing experience or legal disputes that arise as a result thereof. Any legal matters will be subject to Texas state law jurisdiction.',
    },
];
